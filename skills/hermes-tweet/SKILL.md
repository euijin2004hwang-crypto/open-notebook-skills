...
## Open Notebook Companion

Use this companion skill when an Open Notebook workflow needs X/Twitter source
context before search, RAG, notes, or source ingestion. Hermes Tweet gathers and
summarizes social context; Open Notebook stores, searches, and reasons over the
curated research material.

Recommended flow:

1. Use Hermes Tweet to find public tweets, profiles, replies, or monitored
   threads relevant to the notebook topic.
2. Summarize findings and collect public URLs or citations.
3. Add only the useful, public research material to Open Notebook through the
   Open Notebook skill.
